...
INSERT INTO `Type` (ID,Nom,Note) VALUES 
 (1,'Crop',NULL),
 (2,'Elevage',NULL),
 (3,'Hunt',NULL),
 (4,'Perenial',NULL),
...
DROP TABLE IF EXISTS `Ext_Quantite`;
CREATE TABLE IF NOT EXISTS `Ext_Quantite` (
	`ID`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
DROP TABLE IF EXISTS `Ext_Pluriannuelle`;
CREATE TABLE IF NOT EXISTS `Ext_Pluriannuelle` (
	`ID`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	`Quantite_Avant_1`	TEXT,
	`1`	TEXT,
	`2`	TEXT,
...
DROP TABLE IF EXISTS `Ext_Perenne`;
CREATE TABLE IF NOT EXISTS `Ext_Perenne` (
	`ID`	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	`IdExternalites`	INTEGER,
	`Ph1`	TEXT,
	`Ph2`	TEXT,
...
INSERT INTO `Def_EtatSortie` (ID,IdDefinitions,IdDefCateg,IdEtatSortie,Nom) VALUES (1,NULL,NULL,NULL,'test'),
 (2,NULL,NULL,NULL,'test22'),
 (3,NULL,NULL,NULL,'test3'),
 (4,NULL,NULL,NULL,'test4'),
 (5,NULL,NULL,NULL,'fff');
...
INSERT INTO `DICO_TYPO` (ID,TYPE) VALUES ('1','Forêt dense'),
 ('2','Jachère forestière'),
 ('3','Jeune jachère'),
 ('4','Champ'),
 ('5','Village'),
 ('6','Zone protégée/sacrée');
...
INSERT INTO `DICO_NATURE` (ID,A_PRECISER,NATURE) VALUES (1,'0','Campement'),
 (2,'0','Chasse'),
 (3,'0','Pêche'),
 (4,'0','Agriculture'),
 (5,'0','Récolte PFNL'),
 ...
 (7,'0','Cimetière / tombe'),
 (8,'0','Ancien village'),
 (9,'0','Autre activité en lien avec l''eau'),
 (10,'0','Débarcadère'),
 (11,'0','Lac'),
 (12,'0','Baï'),
 (13,'0','Limite'),
 (14,'0','Piste'),
 (15,'1','Autre (à préciser)'),
 (16,'0','Pépinière'),
 (17,'0','Pont / Buse'),
 (18,'0','Rivière'),
 (23,'0','Pastos y ganado'),
 (24,'0','Terrain de sport'),
 (25,'0',''),
 (26,'0','Forêt'),
 (27,'0','Ecole'),
 (28,'0','Pulperia'),
...
INSERT INTO `Agri_EmpLT` (ID,IdExploitation,Nom,Montant,Duree1,Duree2,Taux1,Taux2,Type,DateReal,DateRemb,Ent_Pri,Nombre_Variation,Duree3,Duree4,Duree5,Taux3,Taux4,Taux5,Periodicite) VALUES (1,1,'emprun1','1000','10',NULL,5.0,NULL,'Constant','10/12/2018','10/12/2017','Entreprise',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Annual'),
 (2,1,'emprunt 2','20','12',NULL,1.0,NULL,'Variable','10/12/2015','10/12/1547','Entreprise',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Annual');
...
INSERT INTO `Agri_Animaux` (ID,IdExploitations,IdActivite) VALUES (1,11,6),
 (2,3,4),
 (6,12,4),
 (7,12,4),
 (8,12,4),
